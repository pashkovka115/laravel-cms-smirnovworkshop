...
@section('content')
	...
	<div class="line">
		...
		@include('admin.parts.modal_settings_columns', ["route" => "admin.contact.columns.update"])
		@include('admin.parts.modal_add_property', ['field' => 'contact_id', 'id' => $item->id, 'route' => 'admin.contact.property.store'])
	</div>
	<div class="py-2">
		<form action="{{ route('admin.contact.update', ['id' => $item->id]) }}" method="post"
