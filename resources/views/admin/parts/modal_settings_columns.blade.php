								...
								<div class="tab-pane tab-example-design fade show active" id="pills-striped-rows-design"
									...
									<div class="table-responsive">
										...
										<tr>
												...
												<th class="bg-light-secondary" style="max-width: 150px">Сортировка в списке</th>
												<th class="bg-light-info" style="max-width: 150px">Сортировка на детальной</th>
													...
													<tr>
														...
														<td class="bg-light-secondary">
															<input type="text" name="{{ $column['id'] }}[sort_list]"
																		 value="{{ $column['sort_list'] }}" style="max-width: 150px">
														</td>
														<td class="bg-light-info">
															<input type="text" name="{{ $column['id'] }}[sort_single]"
																		 value="{{ $column['sort_single'] }}" style="max-width: 150px">
														</td>
