...
@section('content')
    ...
    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                            ...
                            <ul class="list-group">
                                ...
                                @foreach($columns as $column)
                                    <li class="list-group-item">
                                        <ul class="list-group list-group-horizontal">
                                            <li class="list-group-item">
                                                <input type="text" name="{{ $column['id'] }}[show_name]" value="{{ $column['show_name'] }}">
                                            </li>
                                            <li class="list-group-item">
                                                <input type="text" name="{{ $column['id'] }}[sort]" value="{{ $column['sort'] }}">
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" name="{{ $column['id'] }}[is_show_anons]" @if($column['is_show_anons'] == '1') checked @endif>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" name="{{ $column['id'] }}[is_show_single]" @if($column['is_show_single'] == '1') checked @endif>
                                            </li>
                                        </ul>
                                    </li>
                                @endforeach
