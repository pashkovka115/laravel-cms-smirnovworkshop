...
@section('content')
	...
	<div class="line">
		...
		<!-- End Modal -->
		@include('admin.parts.modal_add_property', ['field' => 'category_id', 'id' => $item->id])
	</div>
	<div class="py-2">
		<form action="{{ route('admin.product.category.update', ['id' => $item->id]) }}" method="post"
							...
							<div class="col-xl-3 col-lg-3 col-md-6 col-12 mb-1">
								<div class="card">
									<div class="card-body category-product-property">
										...
										<br>
										<label class="form-label" title="Произвольно">Ключ
