                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="">
                                                ...
                                                @elseif($column['type'] == 'img')
                                                    <input type="file" name="{{ $column['origin_name'] }}"
                                                           class="form-control">
                                                    @if($item->{$column['origin_name']})
                                                        ...
                                                        <div class="form-check" style="margin-top: 10px">
                                                            <input name="delete_{{ $column['origin_name'] }}"
                                ...
                                <div class="card">
                                    <div class="card-body category-product-property">
                                        <label class="form-label" title="Произвольно">Имя
                                            <input type="text" name="properties[name][{{ $loop->iteration }}]"
                                                   class="form-control"
                                                   value="{{ $prop->name }}">
                                        </label>
                                        <br>
                                        <label class="form-label" title="Произвольно">Тип
                                            <input type="text" name="properties[type][{{ $loop->iteration }}]"
                                                   class="form-control"
                                                   value="{{ $prop->type }}">
                                        </label>
                                        <br>
                                        <label class="form-label" title="Произвольно">Ключ<span class="red">*</span>
                                            <input type="text" name="properties[key][{{ $loop->iteration }}]"
                                                   class="form-control"
                                                   value="{{ $prop->key }}">
                                        </label><br>

                                        <label class="form-label">Значение
                                            <textarea name="properties[value][{{ $loop->iteration }}]"
                                                      class="form-control"
                                                      title="Произвольно"
                                        ...
                                        <div class="checkbox-line">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                       for="flexCheckChecked{{ $loop->iteration }}">Удалить</label>
                                            </div>
                                            <br>
                                            <div class="form-check">
                                                <input name="properties[is_show][{{ $loop->iteration }}]"
                                                       class="form-check-input delete-property" type="checkbox"
                                                       value="{{ $loop->iteration }}"
                                                       id="is_show{{ $loop->iteration }}"
                                                       @if($prop->is_show) checked @endif>
