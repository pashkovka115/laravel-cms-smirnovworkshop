							...
							<div class="header-mini-cart">
								...
								<div class="mini-cart-dropdown">
									...
									<div class="cart-item-wrap">
										<div class="cart-item">
											<div class="thumb">
												<a href="#/"><img class="w-100" src=" <?= asset('assets/site') ?>/img/shop/cart/mini1.jpg" alt="Image-HasTech"></a>
										...
										<div class="cart-item">
											<div class="thumb">
												<a href="#/"><img class="w-100" src=" <?= asset('assets/site') ?>/img/shop/cart/mini2.jpg" alt="Image-HasTech"></a>
												<a class="remove" href="javascript:void(0);"><i class="fa fa-trash-o"></i></a>
											</div>
											<div class="content">
					...
					<div class="row">
						<div class="col-12 text-center">
							<div class="page-header-content">
								<{{$name_lavel}} class="title" data-aos="fade-down" data-aos-duration="1200">@yield('page_title')</{{$name_lavel}}>
